...
- 先看 `docs/design/ARCHITECTURE_PRINCIPLES.md`，再看具体设计文档。
- 活动区 canonical 文档以 `docs/design/`、`docs/config/` 为准；`docs/**/bak/` 为备份，**不是**发布真源。
- 对外文档只描述当前 AI 成长镜 主链；历史过程稿与本地备份不作为发布真源。
